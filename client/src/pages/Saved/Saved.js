              ...
              <ul className="collection with-header">
                <li className="collection-header">
                  ...
                  <strong>
                    ...
                    <p>
                      Click <i className="fa fa-trash" aria-hidden="true" /> to
                      remove from list.
                    </p>{" "}
                  </strong>
                </li>
                  ...
                  >
                    <div>
                      <p>
                        ...
                        <a className="article-title" href={result.url}>
                          {" "}
                          {result.title}
                        </a>
                      </p>
                      ...
                      <a
                        ...
                        onClick={() => this.deleteSavedArticle(result._id)}
                      >
                        <i
                          className="fa fa-trash save-btn"
                          aria-hidden="true"
                        />
                      </a>
                    </div>
                    <br />
                    Date Published:{" "}
                    {moment(result.date.substring(0, 10)).format("LL")}
                    <br />
                    Date Saved:{" "}
                    {moment(result.save_date)
                      .add("1", "days")
                      .format("LL")}
                  </li>
                ))}
