...
// Fetch a random activity and return only the #cards content
...
// Handle POST request to filter activities
app.post("/activity", async (req, res) => {
  try {
    ...
    const selectedActivity = results.length
    ...
    console.error("Failed to fetch filtered activity:", error.message);
    res.send("<p>No activities match your criteria.</p>");
  }
});
